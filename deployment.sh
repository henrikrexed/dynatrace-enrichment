...
kubectl apply -f deploy/openTelemetry-manifest_debut.yaml
...
kubectl apply -f deploy/openTelemetry-sidecar.yaml -n otel-demo
kubectl apply -f deploy/deployment.yaml -n otel-demo
